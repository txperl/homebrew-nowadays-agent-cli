...
| `claude-code-stable` | <!-- ver:stable -->![v2.1.226](https://img.shields.io/badge/anthropic/stable-v2.1.226-blue)<!-- /ver:stable -->       | Tracks the channel Anthropic has promoted to stable.     |
