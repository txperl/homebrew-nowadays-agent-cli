...
| `claude-code-latest` | <!-- ver:latest -->![v2.1.257](https://img.shields.io/badge/anthropic/latest-v2.1.257-blue)<!-- /ver:latest -->       | Matches the npm `@anthropic-ai/claude-code` latest tag.  |
