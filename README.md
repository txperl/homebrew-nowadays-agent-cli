...
| `claude-code-stable` | <!-- ver:stable -->![v2.1.126](https://img.shields.io/badge/anthropic/stable-v2.1.126-blue)<!-- /ver:stable -->       | Tracks the channel Anthropic has promoted to stable.     |
| `claude-code-latest` | <!-- ver:latest -->![v2.1.136](https://img.shields.io/badge/anthropic/latest-v2.1.136-blue)<!-- /ver:latest -->       | Matches the npm `@anthropic-ai/claude-code` latest tag.  |
