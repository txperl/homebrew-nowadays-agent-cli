...
| `claude-code-stable` | <!-- ver:stable -->![v2.1.191](https://img.shields.io/badge/anthropic/stable-v2.1.191-blue)<!-- /ver:stable -->       | Tracks the channel Anthropic has promoted to stable.     |
| `claude-code-latest` | <!-- ver:latest -->![v2.1.199](https://img.shields.io/badge/anthropic/latest-v2.1.199-blue)<!-- /ver:latest -->       | Matches the npm `@anthropic-ai/claude-code` latest tag.  |
