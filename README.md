...
| Cask                 | Channel                                                                                                               | Notes                                                    |
| -------------------- | --------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| `claude-code`        | <!-- ver:mirror -->![v2.1.149](https://img.shields.io/badge/homebrew/official-v2.1.149-blue)<!-- /ver:mirror -->               | Byte-for-byte copy of the upstream cask file.            |
...
| `claude-code-latest` | <!-- ver:latest -->![v2.1.159](https://img.shields.io/badge/anthropic/latest-v2.1.159-blue)<!-- /ver:latest -->       | Matches the npm `@anthropic-ai/claude-code` latest tag.  |
